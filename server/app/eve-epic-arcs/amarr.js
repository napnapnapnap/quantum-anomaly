export default function () {
  return {
    ...
    'missions':    [{
      ...
      'tips':          ['Don\'t forget to loot 1 x Reports (0.1 m3)'],
      ...
      'type':          'Combat',
      'destination':   'Any system in constellation',
      'description':   ['Fight Sansha', 'Approach the station to be around 60km from all spawn points'],
      'enemy':         'Sansha Nation (Tank against: EM/Thermal, Best damage: EM/Thermal)',
      'pockets':       [[{
      ...
      'tips':          ['Move closer to station to be in better range for reinforcement spawns'],
      ...
      'tips':          ['Bring marauder, good drone damage, a friend or missile ship due to heavy tracking disruption'],
      'completed':     'Complete remotely after last ship is dead.'
    }, {
      ...
      'type':          'Combat',
      'destination':   'Any system in constellation',
      'description':   ['Kill everything, watch out on neutralizer towers',
      ...
      'tips':          ['Shoot down energy neutralizer towers as soon as possible or you might find yourself in serious capacitor issues'],
      'completed':     'Complete remotely after last ship is dead.'
    }, {
      ...
      'description':   ['Fight Sansha forces',
      ...
      'destination':   'Any system in constellation',
      'description':   ['Burn 16 km to the Encrypted Communications Array and hack it',
      ...
      'tips':          ['Don\'t forget to loot 1 x Communications Logs (0.1 m3)'],
      ...
      'type':          'Spy on meeting',
      'destination':   'Same system',
      'description':   ['If you engage ANY ships, you will FAIL this mission',
      ...
      'tips':          ['Just keep shooting as they come, blow up the station at the end',
      ...
      'description':   ['Heavy DPS if you let them come in close, make sure to kill and loot as soon as possible',
                        'Few minutes after last enemy dies, reinforcement will arrive and they hit hard, more then 1200 dps if they come in close',
                        'Reinforcement wave doesn\'t offer any bounty and it\'s fairly bad loot/salvage',
      ...
      'tips':          ['Don\'t forget to loot 1 x Mina Darabi (1.0 m3) at chappel and get out before reinforcement wave',
      ...
      'tips':          ['Don\'t forget to loot 1 x Rahsa (1.0 m3)'],
      'completed':     'Kill everything, loot item, fly back to station.'
    }, {
      ...
      'tips':          ['Kill frigates in initial spawn, then all but one cruiser and battleship',
                        'After that just clear all the battleships, then all the cruisers',
                        'Don\'t forget to loot 1 x The Sansha Command Signal Receiver (0.1 m3)'],
      'completed':     'Kill everything, loot item, fly back to station.'
    }, {
      ...
      'description':   ['Do not forget to take 1 x Homemade Sansha Beacon (1.0 m3) with you',
      ...
      'tips':          ['When returning to your agent stop in system called Palas and dock up your ships/orca',
      ...
      'description':   ['Burn to Harkan\'s Manor',
      ...
      'tips':          ['Do not take your battleship/orca into lowsec',
                        'Use small fast ship'],
      ...
      'type':          'Combat',
      'destination':   'Any system in constellation',
      'description':   ['Kill all ships in area',
