export default function () {
  return {
    ...
    'missions':    [{
      ...
      'description':   ['Arsten Takalo will ask you to bring him 1 x Olfei Medallion (0.1 m3)',
                        'It can be found for about cheap in Rens, or you scan down the plex and kill Olfei and then loot him',
                        'Plex is in same constallation as agent, but I never bothered searching it, simply buy it on market before you even before you start the arc and just give it to him and be done with it'],
      ...
      'description':   ['Go into single pocket mission, kill everything and retrieve item',
      ...
      'tips':          ['Don\'t forget to loot 1 x Hauteker Memoirs (0.1 m3) by placing a key dropped by Ailon into the Archives'],
      ...
      'type':          'Combat and retrieve item',
      'destination':   'Any system in constellation',
      'description':   ['Angel Cartel spawn first, at about 40km',
                        'Amarr spawn after at 30km from warp in',
                        'Retrieve 1 x Wildfire Khumaak (0.3 m3) from the Central Burial Tomb'],
      ...
      'tips':          ['Don\'t forget to loot 1 x Wildfire Khumaak (0.3 m3)'],
      'completed':     'Loot the mission objective and fly back to your agent.'
    }, {
      'name':          'Glowing Embers',
      'agent':         'Arsten Takalo',
      ...
      'description':   ['Deliver 1 x Wildfire Khumaak (0.3 m3) from last mission to a camp 6 jumps away',
      ...
      'description':   ['Same system as last one',
      ...
      'description':   ['Take all your ships with you since this is along the way for next agent, but for this mission use a shuttle',
                        'This isn\'t combat mission and you will need to burn 50-70 kilometers',
      ...
      'tips':          ['Don\'t forget to loot 1 x Singed Datapad (0.1 m3)'],
      'completed':     'Loot the mission objective and fly back to your agent.'
    }, {
      'name':          'Surfacing',
      'agent':         'Nilf Abruskur',
      ...
      'description':   ['Get the objective from structure',
      ...
      'tips':          ['If you are using alt to trigger spawns, move away from warp in beacon since they spawn on the beacon with scramblers',
      ...
      'description':   ['Kill everything, no triggers, sort by range and start working on them',
      ...
      'destination':   'Any system in constellation',
      'description':   ['Hack the container to get 1 x Drive Cluster EDF-285 (0.1 m3)',
      ...
      'tips':          ['Don\'t forget to grab 1 x Drive Cluster EDF-285 (0.1 m3)'],
      'completed':     'Loot the mission objective and fly back to your agent.'
    }, {
      ...
      'destination':   'Any system in constellation',
      'description':   ['Hack the container to get 1 x Blood Obsidian Orb (0.1 m3)',
      ...
      'tips':          ['Don\'t forget to grab 1 x Blood Obsidian Orb (0.1 m3)'],
      'completed':     'Loot the mission objective and fly back to your agent.'
    }, {
      'name':          'Heresiology',
      'agent':         'Hiva Shesha',
      ...
      'type':          'Combat and retrieve item (needs Relic Analyzer)',
      'destination':   'Any system in constellation',
      'description':   ['Hack the containers to get 1 x Engraved Blood Obsidian tablet (0.1 m3)',
      ...
      'tips':          ['Don\'t forget to grab 1 x Engraved Blood Obsidian tablet (0.1 m3)',
      ...
      'destination':   'Any system in constellation',
      'description':   ['No spawn on warp in',
                        'Dropping the 1 x Datacore (0.1 m3) into the chapel container triggers the spawn about 30 km off',
      ...
      'description':   ['Karkoti Rend will aggro up to 200 kilometers away',
      ...
      'tips':          ['Kill tower, keep range on Karkoti so he doesn\'t neut you out, then either kill rest and Karkoti last or just blap him',
                        'Don\'t forget to loot 1 x Book Of St. Arzad (0.1 m3)'],
      'completed':     'Loot the mission objective and fly back to your agent.'
    }, {
      ...
      'tips':          ['Retraction is same deal as this one except you have to return to your agent to pick up probes, so consider using shuttle/frigate',
