  ...
  missions: [
    {
      ...
      desc: ['Report to Kandus Sandar in Nahyeen VI - Ministry of Internal Order Assembly Plant'],
      tips: ['You can start conversation with Karde Romu from anywhere and accept first mission'],
    ...
    },
    {
      ...
      desc: ["Fight Sansha's Nation and get item"],
      enemy: "Sansha's Nation",
      tips: ["Don't forget to loot Reports (0.1 m³) - They should appear in your cargo hold after you kill last enemy"],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Ravener', 'Centii Loyal Scavenger'],
              },
              {
                quantity: 4,
                names: ['Centus Mutant Lord', 'Centus Savage Lord'],
              },
            ],
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Centus Beast Lord', 'Centus Plague Lord'],
              },
            ],
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Centus Dark Lord', 'Centus Overlord'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      start: 'Nahyeen',
      dest: 'Any system in constellation',
      desc: ["Fight Sansha's Nation", 'Approach the station to be around 60km from all spawn points'],
      enemy: "Sansha's Nation",
      tips: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Loyal Savage', 'Centii Loyal Slavehunter'],
              },
              {
                quantity: 3,
                names: ['Centus Plague Lord'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Butcher', 'Centii Loyal Plague', 'Centii Loyal Enslaver'],
              },
              {
                quantity: 3,
                names: ['Centus Dark Lord', 'Centus Overlord'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Loyal Savage', 'Centii Loyal Manslayer', 'Centii Loyal Slavehunter'],
              },
              {
                quantity: 3,
                names: ['Centum Beast', 'Centum Juggernaut'],
                notice: 'Any could trigger wave 2',
              },
              {
                quantity: 2,
                names: ['Centum Loyal Mutilator', 'Centum Loyal Fiend'],
              },
              {
                quantity: 4,
                names: ['Centatis Daemon', 'Centatis Wraith', 'Centatis Phantasm'],
              },
              {
                quantity: 5,
                names: ['Centus Dread Lord', 'Centus Dark Lord', 'Centus Overlord'],
              },
              {
                quantity: 1,
                names: ['Centus Tyrant'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Centii Loyal Servant', 'Centii Loyal Butcher', 'Centii Loyal Enslaver'],
                notice: 'Any could trigger wave 3',
              },
              {
                quantity: 2,
                names: ['Centum Loyal Execrator', 'Centum Loyal Slaughterer'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Centii Loyal Manslayer', 'Centii Loyal Enslaver'],
              },
              {
                quantity: 3,
                names: ['Centum Loyal Torturer', 'Centum Loyal Slaughterer', 'Centum Loyal Hellhound'],
              },
              {
                quantity: 1,
                names: ['Centus Plague Lord'],
    ...
    },
    {
      ...
      enemy: ["Sansha's Nation", 'Amarr Empire'],
      tips: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Minion', 'Centii Loyal Scavenger'],
              },
              {
                quantity: 4,
                names: ['Centus Plague Lord', 'Centus Beast Lord'],
              },
              {
                quantity: 2,
                names: ['Tower Sentry Sansha III'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Loyal Butcher', 'Centii Loyal Manslayer', 'Centii Loyal Enslaver'],
              },
              {
                quantity: 4,
                names: ['Centus Dark Lord', 'Centus Overlord'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Loyal Slavehunter', 'Centii Loyal Savage'],
              },
              {
                quantity: 4,
                names: ['Centus Dark Lord', 'Centus Overlord'],
              ...
              {
                quantity: 2,
                names: ['Sansha Energy Neutralizer Sentry I'],
              },
              {
                quantity: 2,
                names: ['Tower Sentry Sansha III'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centatis Daemon', 'Centatis Devil'],
              },
              {
                quantity: 4,
                names: ['Centus Beast Lord', 'Centus Plague Lord'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Ravener'],
              },
              {
                quantity: 4,
                names: ['Centum Loyal Torturer', 'Centum Loyal Hellhound', 'Centum Loyal Mutilator'],
                notice: 'Last killed will trigger wave 1',
              },
              {
                quantity: 4,
                names: ['Centatis Daemon', 'Centatis Behemoth'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Scavenger', 'Centii Loyal Ravener'],
              },
              {
                quantity: 3,
                names: ['Centus Dread Lord', 'Centus Tyrant'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Loyal Butcher', 'Centii Loyal Plague', 'Centii Loyal Manslayer'],
              },
              {
                quantity: 4,
                names: ['Centus Dark Lord'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Divine Imperial Imran'],
              },
              {
                quantity: 3,
                names: ['Imperial Templar Tamir', 'Imperial Templar Donus'],
              },
              {
                quantity: 3,
                names: ['Imperial Martyr', 'Imperial Dominator'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Imperial Champion', 'Imperial Templar Justicar'],
              },
              {
                quantity: 4,
                names: ['Imperial Templar Ultara', 'Imperial Templar Dominator'],
                notice: 'Closer group at 35km, last killed will trigger wave 2',
              },
              {
                quantity: 3,
                names: ['Divine Imperial Valok', 'Divine Imperial Paladin'],
              },
              {
                quantity: 3,
                names: ['Divine Imperial Tamir'],
              },
              {
                quantity: 3,
                names: ['Imperial Martyr', 'Imperial Ultara', 'Imperial Templar Torah'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Imperial Templar Caius'],
              },
              {
                quantity: 2,
                names: ['Imperial Templar Phalanx'],
              },
              {
                quantity: 2,
                names: ['Imperial Templar Martyr'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      desc: ['Report to Aralin Jick at Nishah VII - Moon 5 - Kor-Azor Family Treasury'],
      tips: ['You can start conversation with Kandus Sandar from anywhere and accept mission'],
      objective: 'Automatically finished once you initiate conversation with next agent',
    },
    {
      ...
      enemy: "Sansha's Nation",
      tips: ['Triggers are random', 'Finish each group before moving to next one'],
      objective: 'Complete remotely after last ship is dead',
      pockets: [
        [
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centum Loyal Mutilator', 'Centum Loyal Hellhound'],
              },
              {
                quantity: 3,
                names: ['Centus Dread Lord', 'Centus Tyrant'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centatis Devil', 'Centatis Wraith'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centum Loyal Fiend', 'Centum Loyal Hellhound', 'Centum Loyal Torturer'],
              },
              {
                quantity: 2,
                names: ['Centus Tyrant', 'Centus Dread Lord'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Minion', 'Centii Loyal Servant'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Centii Loyal Servant', 'Centii Loyal Minion'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centum Loyal Torturer', 'Centum Loyal Mutilator', 'Centum Loyal Fiend'],
              },
              {
                quantity: 2,
                names: ['Centus Dread Lord', 'Centus Tyrant'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centatis Wraith', 'Centatis Devil'],
              },
            ],
          },
          {
    ...
    },
    {
      ...
      tips: ["Don't forget to loot Communications Logs (0.1 m³)"],
    ...
    },
    {
      ...
      start: 'Nishah',
      dest: 'Same system',
      desc: ['Fight Mercenaries and kill the outpost'],
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Mordus Gigamar', 'Mordus Phanti'],
              },
              {
                quantity: 3,
                names: ['Caldari Cruise Missile Battery'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Mordus Puma', 'Mordus Leopard'],
              },
              {
                quantity: 4,
                names: ['Mordus Gigamar', 'Mordus Phanti', 'Mordus Mammoth'],
              },
              {
                quantity: 3,
                names: ['Caldari Cruise Missile Battery'],
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 2,
                names: ['Mordus Gigamar'],
                notice: 'Last killed will trigger wave 1',
              },
              {
                quantity: 3,
                names: ['Caldari Heavy Missile Battery'],
              },
              {
                quantity: 3,
                names: ['Caldari Cruise Missile Battery'],
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Mordus Leopard'],
              },
              {
                quantity: 4,
                names: ['Mordus Gigamar', 'Mordus Mammoth'],
                notice: 'Last killed will trigger wave 2',
              },
            ],
          },
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 2,
                names: ['Amarr Light Missile Battery'],
              },
              {
                quantity: 2,
                names: ['Amarr Cruise Missile Battery'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Independent Abaddon', 'Independent Armageddon', 'Independent Apocalypse'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Independent Veteran Crucifier', 'Independent Veteran Inquisitor'],
              },
              {
                quantity: 6,
                names: ['Independent Veteran Omen', 'Independent Veteran Maller', 'Independent Veteran Augoror'],
              },
              {
                quantity: 6,
                names: [
    ...
    },
    {
      ...
      start: 'Nishah',
      dest: 'Any system in constellation',
      desc: ['Fight Sansha an capture enemy commander'],
      enemy: "Sansha's Nation",
      tips: ["Don't forget to loot Rahsa (1.0 m³)"],
      pockets: [
        [
          {
            range: '10 kilometers',
            enemies: [
              {
                quantity: 6,
                names: ['Centum Loyal Fiend', 'Centum Loyal Hellhound'],
              },
              {
                quantity: 3,
                names: ['Centus Dark Lord', 'Centus Dread Lord'],
              },
              {
                quantity: 6,
                names: ['Sansha Heavy Missile Battery'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Centatis Devil', 'Centatis Daemon'],
                notice: 'Last killed will trigger wave 2',
              },
              {
                quantity: 4,
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centum Loyal Mutilator', 'Centum Loyal Torturer'],
              },
              {
                quantity: 3,
                names: ['Centus Beast Lord', 'Centus Savage Lord', 'Centus Overlord'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Plague', 'Centii Loyal Butcher'],
              },
              {
                quantity: 2,
                names: ['Centus Beast Lord', 'Centus Plague Lord'],
    ...
    },
    {
      ...
      tips: ['Interrogation: Catching the Scent should be the next mission choice'],
    ...
    },
    {
      ...
      start: 'Nishah',
      dest: 'Any system in constellation',
      desc: ['Fight Sansha an loot Sansha Command Signal Receiver'],
      enemy: "Sansha's Nation",
      tips: [
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 5,
                names: ['Centum Mutilator', 'Centum Torturer'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centum Hellhound', 'Centum Fiend'],
                notice: 'Trigger wave 2, just Cruisers',
              },
              {
                quantity: 5,
                names: ['Centus Dread Lord', 'Centus Dark Lord'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centum Loyal Torturer', 'Centum Loyal Mutilator'],
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 1,
                names: ['Independent Veteran Augoror', 'Independent Veteran Arbitrator', 'Independent Veteran Omen'],
              },
              {
                quantity: 5,
                names: [
    ...
    },
    {
      ...
      tips: ['Do not take your battleship/orca into lowsec', 'Use small fast ship'],
    ...
    },
    {
      ...
      desc: ['Report to Riff Hebian in Palas at Miyan Security Forces Beacon'],
      tips: ['Your battleship should be there already if you left it there 2 missions ago'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Centii Servant', 'Centii Minion'],
                notice: 'Trigger same number of frigates five times',
              },
              {
                quantity: 4,
                names: ['Centum Ravisher', 'Centum Ravager'],
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 1,
                names: ['Amarr Stasis Tower'],
              },
              {
                quantity: 1,
                names: ['Amarr Energy Neutralizer Sentry III'],
              },
            ],
          },
        ],
      ],
      tips: ['Blitz the mission by killing neutralizer tower as soon as it spawns'],
    ...
    },
    {
      ...
      desc: ['Fight Sansha and kill Harkan'],
      enemy: "Sansha's Nation",
      tips: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centum Loyal Hellhound', 'Centum Loyal Fiend'],
              },
              {
                quantity: 3,
                names: ['Centatis Devil', 'Centatis Wraith'],
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 2,
                names: ['Centum Slaughterer', 'Centum Execrator'],
              },
              {
                quantity: 4,
                names: ['Centum Loyal Hellhound', 'Centum Loyal Fiend'],
              ...
              {
                quantity: 3,
                names: ['Centatis Wraith', 'Centatis Behemoth'],
              },
              {
                quantity: 3,
                names: ['Centus Plague Lord', 'Centus Beast Lord'],
        ...
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Enslaver', 'Centii Loyal Manslayer', 'Centii Loyal Plague'],
              },
              {
                quantity: 3,
                names: ['Centum Loyal Slaughterer', 'Centum Loyal Execrator'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centior Monster'],
              },
              {
                quantity: 1,
                names: ['Centus Tyrant'],
                notice:
                  'Trigger next a group like wave 1 at 10% shield, at 10% armor, getting structure damage and destruction',
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Centii Loyal Enslaver', 'Centii Loyal Butcher'],
                notice: 'Random one is trigger wave 2',
              },
              {
                quantity: 3,
                names: ['Centus Overlord', 'Centus Dark Lord'],
                notice: 'Random one is trigger wave 2',
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centum Loyal Hellhound', 'Centum Loyal Torturer'],
              },
              {
                quantity: 2,
                names: ['Centatis Daemon', 'Centatis Behemoth'],
        ...
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centior Cannibal'],
              },
              {
                quantity: 2,
                names: ['Centum Execrator'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centior Abomination'],
              },
              {
                quantity: 2,
                names: ['Centum Slaughterer'],
              },
            ],
          },
          {
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Centii Loyal Slavehunter'],
                notice: 'Attacking any will trigger wave 4, this repeats 4-5 times in total',
              },
              {
                quantity: 2,
                names: ['Centum Loyal Mutilator', 'Centum Loyal Torturer', 'Centum Loyal Slaughterer'],
