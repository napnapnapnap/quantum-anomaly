export const data = {
  ...
  missions: [
    ...
    },
    {
      ...
      desc: ['Deliver Questionable Cargo (3.0 m³) to Josameto which is one jump out'],
      tips: ["Don't forget to take to cargo with you when you undock", 'Can complete remotely'],
    ...
    },
    {
      ...
      desc: ['Destroy Hyasyoda Research Facility and loot S.I Formula Sheet (0.1 m³)'],
      enemy: 'Serpentis',
      tips: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Corelum Guardian Chief Infantry', 'Corelum Guardian Chief Sentinel'],
              },
              {
                quantity: 5,
                names: ['Core Admiral', 'Core Rear Admiral', 'Core Vice Admiral'],
              },
              {
                quantity: 1,
                names: ['Core Grand Admiral'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Coreli Guardian Protector', 'Coreli Guardian Defender', 'Coreli Guardian Patroller'],
              },
              {
                quantity: 5,
                names: ['Core Admiral', 'Core Rear Admiral', 'Core Vice Admiral'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Coreli Guardian Protector', 'Coreli Guardian Initiate', 'Coreli Guardian Defender'],
              },
              {
                quantity: 5,
                names: ['Corelum Guardian Chief Infantry', 'Corelum Guardian Chief Sentinel'],
              ...
              {
                quantity: 4,
                names: ['Core Admiral', 'Core Rear Admiral', 'Core Vice Admiral', 'Core Flotilla Admiral'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Coreli Guardian Guard', 'Coreli Guardian Safeguard'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      tips: ['Take the formula with you', 'Do not forget the formula', 'You will forget the formula sooner or later'],
      objective: 'Fly to destination and start conversation with agent.',
    },
    {
    ...
    },
    {
      ...
      tips: ['Do not forget to take formula with you', 'Take care navigating lowsec if you never did it before'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Federation Navy Soldier'],
              },
              {
                quantity: 10,
                names: ['Federation Navy Thorax'],
              },
              {
                quantity: 6,
                names: ['Federation Navy Dominix'],
              },
            ],
          },
        ],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Federation Praktor Belos', 'Federation Praktor Harpago'],
              },
              {
                quantity: 7,
                names: [
              ...
              {
                quantity: 5,
                names: ['Federation Arcus', 'Federation Pelekus'],
              },
              {
                quantity: 10,
                names: ['Federation Praktor Centurion', 'Federation Praktor Legionarius'],
              },
              {
                quantity: 9,
                names: [
              ...
              {
                quantity: 5,
                names: ['Federation Praktor Bearcus', 'Federation Calo'],
              },
              {
                quantity: 13,
                names: [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Elite Federation Manica'],
              },
              {
                quantity: 2,
                names: ['Elite Federation Matara'],
              },
              {
                quantity: 5,
                names: ['Elite Federation Arcus'],
              },
            ],
          },
        ],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Federation Praktor Belos', 'Federation Praktor Machina', 'Federation Praktor Harpago'],
              },
              {
                quantity: 3,
                names: ['Federation Praktor Phalarica'],
              },
              {
                quantity: 3,
                names: ['Elite Federation Lixa', 'Elite Federation Libertus'],
              },
              {
                quantity: 6,
                names: ['Elite Federation Machina', 'Elite Federation Matara'],
              },
              {
                quantity: 4,
                names: ['Elite Federation Arx'],
              },
              {
                quantity: 7,
                names: [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Shadow Serpentis Warden'],
              },
              {
                quantity: 8,
                names: ['Federation Detention Facility FNSBR-106V.1'],
                notice:
                  'Each contains Caldari Prisoner Of War, they all blow up once you hack first one successfully so once you hack, grab it and run since you only need one.',
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      tips: ["Don't forget Encrypted Data Node (1.0 m³)"],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
    ...
    },
    {
      ...
      desc: ['Report to Arikio Kuretsu at Wuos V - Moon 1 - Hyasyoda Corporation Mining Outpost'],
        ...
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 13,
                names: ['Taibu State Wakizashi', 'Taibu State Suriage', 'Taibu State Shirasaya', 'Taibu State Shinai'],
              },
              {
                quantity: 4,
                names: ['Taibu State Daimyo', 'Taibu State Shugo'],
              },
              {
                quantity: 6,
                names: ['State Shukuro Shogun', 'State Shukuro Nagashin'],
              },
            ],
          },
        ],
