  ...
  missions: [
    {
      ...
      start: 'Frarn',
      dest: 'Any system in Sveipar constellation',
      desc: [
        'Arsten Takalo will ask you to bring him Olfei Medallion (0.1 m³)',
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Arch Gistii Outlaw', 'Arch Gistii Thug'],
              },
              {
                quantity: 11,
                names: ['Arch Gistum Crusher'],
              },
              {
                quantity: 3,
                names: ['Container'],
                notice: 'Each holds Olfei Medallion (0.1 m³)',
              },
            ],
          },
        ],
      ],
      tips: ['Buy the Medallion on market, they should be less then million and save yourself travel time at least'],
      objective: 'Fly to agent and give him Olfei Medallion (0.1 m³).',
    },
    {
        ...
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Mercenary Wingman'],
              },
              {
                quantity: 6,
                names: ['Mercenary Corporal', 'Mercenary Lieutenant'],
              },
              {
                quantity: 5,
                names: ['Mercenary Overlord'],
              },
            ],
          },
          {
      ...
      tips: ["Don't forget to loot Hauteker Memoirs (0.1 m³) by placing a key dropped by Ailon into the Archives"],
    ...
    },
    {
      ...
      desc: [
        ...
        'Retrieve Wildfire Khumaak (0.3 m³) from the Central Burial Tomb',
      ],
      enemy: ['Angel Cartel', 'Amarr Empire'],
      pockets: [
        [
          {
            range: 40,
            enemies: [
              ...
              {
                quantity: 3,
                names: ['Arch Gistum Breaker', 'Arch Gistum Defeater'],
              },
              {
                quantity: 7,
                names: ['Arch Gistum Centurion', 'Arch Gistum Phalanx'],
              },
              {
                quantity: 3,
                names: ['Gistatis Legatus', 'Gistatis Tribunus'],
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 1,
                names: ['Imperial Templar Judgment'],
              },
            ],
          },
        ],
      ],
      tips: ["Don't forget to loot Wildfire Khumaak (0.3 m³)"],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
      name: 'Glowing Embers',
      ...
      type: 'Courier',
      start: 'Frarn',
      dest: 'Todeko system , 6 jump out',
      desc: [
        'Deliver Wildfire Khumaak (0.3 m³) from last mission to a camp 6 jumps away',
      ...
      tips: ['Do not start next mission straight away if you are doing this arc with more then one character'],
    ...
    },
    {
      ...
      type: 'Combat',
      start: 'Frarn',
      dest: 'Todeko system , 6 jump out (same as last mission destination)',
      desc: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Arch Gistii Ambusher', 'Arch Gistii Raider'],
              },
              {
                quantity: 3,
                names: ['Arch Gistum Phalanx', 'Arch Gistum Centurion'],
              },
              {
                quantity: 2,
                names: ['Gistatis Praefectus', 'Gistatis Tribunus'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Arch Gistii Ruffian'],
              },
              {
                quantity: 3,
                names: ['Arch Gistum Marauder', 'Arch Gistum Liquidator'],
              },
              {
                quantity: 1,
                names: ['Gist Warlord'],
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 3,
                names: ['Gist Throne', 'Gist Cherubim'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Arch Gistii Impaler', 'Arch Gistii Hunter'],
              },
              {
                quantity: 4,
                names: ['Gistior Seizer', 'Gistior Trasher'],
              },
              {
                quantity: 3,
                names: ['Gistatis Legatus', 'Gistatis Tribunus'],
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 2,
                names: ['Gist Domination Saint', 'Gist Domination Nephilim'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      start: 'Frarn',
      dest: 'Alakgur system , 3 jump out (8 jumps from last mission)',
      desc: [
      ...
      tips: ['You can also use your main ships for this if they can cross 50+ kilometers in reasonable time'],
    ...
    },
    {
      ...
      type: 'Travel',
      start: 'Frarn',
      dest: 'Aldrat system, 8 jumps away (11 jumps from last mission)',
      desc: ['Report to Nilf Abruskur in Aldrat at RSS Liaison Headquarters'],
      tips: ['You can accept mission remotely'],
    ...
    },
    {
      ...
      start: 'Aldrat',
      dest: 'Any system in constellation',
      desc: ['Kill one battleship and loot datapad from him'],
      ...
      tips: ["Don't forget to loot Singed Datapad (0.1 m³)"],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
      name: 'Surfacing',
      ...
      type: 'Combat and retrieve item',
      start: 'Aldrat',
      dest: 'Jark system, 11 jumps away',
      desc: [
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 7,
                names: ['Arch Gistii Hunter', 'Arch Gistii Impaler'],
              },
              {
                quantity: 4,
                names: ['Arch Gistum Breaker', 'Arch Gistum Defeater'],
              ...
              {
                quantity: 7,
                names: ['Gist Cherubim', 'Gist Seraphim', 'Gist Throne'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Gistii Hunter', 'Gistii Impaler'],
              },
              {
                quantity: 3,
                names: ['Arch Gistii Hunter'],
              },
              {
                quantity: 3,
                names: ['Gistatis Praefectus'],
              },
            ],
          },
        ],
      ],
      tips: ['Sort at range and kill everything or blitz the mission'],
    ...
    },
    {
      ...
      dest: 'Any system in constellation',
      desc: [
        'Hack the container to get Drive Cluster EDF-285 (0.1 m³)',
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 4,
                names: ['Arch Gistum Phalanx', 'Arch Gistum Defeater', 'Arch Gistum Centurion'],
              },
              {
                quantity: 10,
                names: ['Gist Cherubim', 'Gist Seraphim', 'Gist Throne'],
      ...
      tips: ["Don't forget to grab Drive Cluster EDF-285 (0.1 m³)"],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
      ...
      desc: ['Report to Hiva Shesha in Tanoo at Krusal Mobile Library'],
      tips: ['You can accept mission remotely'],
      objective: 'Automatically once you initiate conversation with next agent.',
    },
    {
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 3,
                names: ['Ammatar Navy Armageddon', 'Ammatar Navy Apocalypse'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Ammatar Navy Soldier'],
              },
              {
                quantity: 5,
                names: ['Ammatar Navy Maller'],
              },
              {
                quantity: 10,
                names: ['Ammatar Navy Armageddon', 'Ammatar Navy Apocalypse'],
      ...
      tips: ["Don't forget to grab Blood Obsidian Orb (0.1 m³)"],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
      name: 'Heresiology',
      ...
      tips: [
        "Don't forget to grab Engraved Blood Obsidian tablet (0.1 m³)",
    ...
    },
    {
      ...
      desc: [
        'No spawn on warp in',
        'Dropping the Datacore (0.1 m³) into the chapel container triggers the spawn about 30 km off',
      ...
      tips: ['If you want to blitz this mission, drop item, align out, as soon as Rend warps off you can warp off'],
    ...
    },
    {
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Arch Gistii Hijacker', 'Arch Gistii Hunter', 'Arch Gistii Impaler'],
              },
              {
                quantity: 3,
                names: ['Arch Gistum Centurion', 'Arch Gistum Phalanx'],
              ...
              {
                quantity: 1,
                names: ['Angel Energy Neutralizer Sentry II'],
              },
            ],
          },
        ],
      ...
      tips: [
        ...
        "Don't forget to loot Book Of St. Arzad (0.1 m³)",
      ],
      objective: 'Loot the mission objective and fly back to your agent.',
    },
    {
      ...
      tips: ['Pick one you want, either 10% base standings or 5% base standings + probes'],
    ...
    },
    {
      ...
      type: 'Courier',
      start: 'Tanoo',
      dest: 'Avesber system, 5 jumps away',
      desc: ['Fly couple of jumps and drop Book Of St. Arzad (0.1 m³) into container'],
      tips: [
