  ...
  missions: [
    {
      ...
      desc: ['Talk to Roineron Aviviere and take mission to report to Gian Parele in Tolle Solar system'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Barracuda Alvi', 'Devilfish Alvi', 'Strain Decimator Alvi'],
              },
              {
                quantity: 2,
                names: ['Disintegrator Alvum'],
              },
              {
                quantity: 4,
                names: ['Enforcer Alvatis', 'Striker Alvatis'],
              },
              {
                quantity: 2,
                names: ['Matriarch Alvus', 'Patriarch Alvus'],
              },
            ],
          },
        ],
        [
          ...
          },
          {
            ...
            enemies: [
              ...
              {
                quantity: 3,
                names: ['Defeater Alvatis'],
              },
              {
                quantity: 7,
                names: ['Alvus Queen', 'Matriarch Alvus', 'Patriarch Alvus'],
              },
            ],
          },
        ],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Republic Tribal Takan', 'Republic Tribal Baldur', 'Chief Republic Gleeda'],
              },
              {
                quantity: 4,
                names: ['Republic Tribal Jarpur', 'Republic Tribal Manadis'],
              },
              {
                quantity: 3,
                names: ['Republic Tribal Jotun', 'Republic Tribal Sigur'],
              },
            ],
          },
        ],
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Chief Republic Hrakt'],
              },
              {
                quantity: 5,
                names: ['Chief Republic Manadis', 'Chief Republic Rodul'],
              },
              {
                quantity: 3,
                names: ['Republic Tribal Jotun', 'Republic Tribal Kinai', 'Republic Tribal Sigur'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      desc: ['Fight Mercenaries in couple of waves'],
      enemy: 'Mercenaries',
      pockets: [
        [
          {
    ...
    },
    {
      ...
      desc: ['Report to Eron Viette in Stetille system'],
    ...
    },
    {
      ...
      desc: ['Report to Mourmarie Mone in Noghere system'],
      tips: ['You can start conversation with Gian Parele from anywhere and accept mission'],
      objective: 'Automatically once you initiate conversation with next agent.',
    },
    {
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Asteroid Micro-Colony Minor'],
        ...
        [
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Independent Rupture', 'Independent Stabber'],
              },
              {
                quantity: 3,
                names: [
    ...
    },
    {
      ...
      desc: ['Get the ringmaster'],
      enemy: ['Serpentis', 'Angel Cartel'],
      pockets: [
        [
          {
            range: 0,
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Sinful Saints', 'Gistum Centurion'],
              },
              {
                quantity: 4,
                names: ['Consumption Junkies', 'Corelatis Wing Leader'],
              },
              {
                quantity: 3,
                names: ['Sinful Saints', 'Gist Seraphim'],
              },
              {
                quantity: 4,
                names: ['Consumption Junkies', 'Core High Admiral'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Lustadores', 'Corelum Guardian Chief Safeguard'],
              },
              {
                quantity: 3,
                names: ['Lustadores', 'Corelatis Captain Sentry'],
              },
            ],
          },
        ],
        [
          {
            ...
            enemies: [
              {
                quantity: 2,
                names: ['Lustadores', 'Gistum Liquidator'],
              },
              {
                quantity: 2,
                names: ['Lustadores', 'Corelum Guardian Chief Safeguard'],
              ...
              {
                quantity: 2,
                names: ['Consumption Junkies', 'Corelatis High Captain'],
              },
              {
                quantity: 3,
                names: ['Consumption Junkies', 'Corelatis Platoon Leader'],
              },
              {
                quantity: 2,
                names: ['Sinful Saints', 'Gist Saint'],
              },
              {
                quantity: 2,
                names: ['Lustadores', 'Core Vice Admiral'],
              },
            ],
          },
          {
      ...
      tips: ["Don't forget to loot The Ringmaster (1.0 m³)"],
    ...
    },
    {
      ...
      desc: ['Battleships are using MWD and will close in fast and deal heavy DPS'],
      enemy: 'Mercenaries',
      pockets: [
        [
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Intaki Settlement Control Tower'],
          ...
          },
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Independent Veteran Dominix'],
                notice: 'Trigger wave II',
              },
              {
                quantity: 2,
                names: ['Independent Megathron', 'Independent Dominix'],
              },
              {
                quantity: 3,
                names: [
              ...
              {
                quantity: 3,
                names: ['Independent Veteran Celestis', 'Independent Veteran Exequror'],
              },
              {
                quantity: 3,
                names: ['Independent Thorax', 'Independent Exequror'],
              },
              {
                quantity: 3,
                names: ['Independent Veteran Incursus', 'Independent Veteran Maulus'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Independent Veteran Megathron', 'Independent Veteran Hyperion'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Independent Veteran Dominix', 'Independent Veteran Megathron'],
              },
            ],
          },
        ],
    ...
    },
    {
      ...
      desc: ['Report to Ascain Adeset in Mesybier'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 5,
                names: ['Independent Hyperion', 'Independent Dominix'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Independent Veteran Imicus', 'Independent Veteran Incursus'],
              },
              {
                quantity: 3,
                names: ['Independent Veteran Hyperion', 'Independent Veteran Megathron'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 6,
                names: ['Independent Hyperion', 'Independent Dominix', 'Independent Megathron'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Independent Veteran Thorax', 'Independent Veteran Vexor', 'Independent Veteran Exequror'],
              },
            ],
          },
        ],
      ],
      tips: ['Kill the fuel depots to get Carry on Token which can be used to blitz next mission'],
      objective: 'Kill everything, fly back to station.',
    },
    {
      name: 'Carry On',
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 1,
                names: ['Acceleration Gate - The Hub'],
                notice: 'Locked, required Carry on token',
              },
              {
                quantity: 1,
                names: ['Acceleration Gate - The Alley'],
              },
            ],
          },
          {
            ...
            enemies: [
              {
                quantity: 3,
                names: ['Independent Veteran Thorax', 'Independent Veteran Vexor', 'Independent Veteran Celestis'],
              },
              {
                quantity: 8,
                names: ['Independent Hyperion', 'Independent Dominix', 'Independent Megathron'],
              ...
              {
                quantity: 6,
                names: ['Gallente Cruise Missile Battery'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 8,
                names: ['Independent Thorax', 'Independent Vexor', 'Independent Celestis', 'Independent Exequror'],
              },
              {
                quantity: 6,
                names: ['Independent Hyperion', 'Independent Dominix', 'Independent Megathron'],
              ...
              {
                quantity: 2,
                names: ['Gallente Heavy Missile Battery'],
        ...
        [
          {
            ...
            enemies: [
              {
                quantity: 4,
                names: ['Independent Veteran Tristan', 'Independent Veteran Maulus', 'Independent Veteran Atron'],
              },
              {
                quantity: 2,
                names: ['Independent Veteran Thorax', 'Independent Veteran Vexor', 'Independent Veteran Celestis'],
              ...
              {
                quantity: 3,
                names: ['Carry On Freighter', 'Freighter'],
              },
              {
                quantity: 2,
                names: ['Carry On Courier', 'Carry On Industrial', 'Industrial'],
              },
              {
                quantity: 1,
                names: ['Carry on Hub'],
        ...
        [
          {
            ...
            enemies: [
              ...
              {
                quantity: 2,
                names: ['Independent Veteran Hyperion', 'Independent Veteran Dominix', 'Independent Veteran Megathron'],
              },
            ],
          },
          {
    ...
    },
    {
      ...
      enemy: ['Mercenaries', 'Minmatar Republic'],
      pockets: [
        [
          {
            range: 60,
