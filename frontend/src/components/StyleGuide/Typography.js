...
const Typography = () => (
  <React.Fragment>
    ...
    <section className="styleguide__section styleguide__section--large">
      <h1>Text</h1>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi ultricies, tortor id aliquam aliquet, urna ipsum
        hendrerit augue, sed facilisis mauris nibh non ligula. Duis arcu velit, malesuada sed odio eu, sodales mattis
        leo. Integer vitae metus sodales, tincidunt justo quis, hendrerit eros. Aenean luctus mi vitae nunc cursus
      ...
      <p className="long-text">
        ...
        ante. Morbi euismod dui rhoncus vestibulum
      </p>
      <p>
        <span className="text--bold">
          Span <code>className='text--bold'</code>
        </span>
      </p>
      <p>
        <span className="italic">
          Span <code>className='italic'</code>
        </span>
      </p>
      <p>
        <span className="monospace">
          Span monospaced <code>className='monospace'</code>
        </span>
      </p>
      <p>
        <span className="capitalize">
          span all lowercase <code>className='capitalize'</code>
        </span>
      </p>
      <p>
        <span className="muted">
          Span <code>className='muted'</code>
        </span>
      </p>
      <p>
        <span className="disclaimer">
          Span <code>className='disclaimer'</code>
        </span>
      </p>
      <div className="styleguide__flex">
        ...
        <section className="styleguide__section--small">
          <ul className="ul--packed">
            <li>
              List <code>className='ul--packed'</code>
            </li>
            <li>Item</li>
            <li>Item</li>
          </ul>
        ...
        <section className="styleguide__section--small">
          <ul className="ul--links">
            <li>
              List <code>className='ul--links'</code>
            </li>
            <li>
              <a href="#">Link</a>
            </li>
