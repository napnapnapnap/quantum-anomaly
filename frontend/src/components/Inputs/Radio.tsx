  ...
  return (
    <div className="input-radio-group">
      {options.map((option, index) => (
        <label
          key={option.value}
          className={clsx('input-control input-control--radio', className, {
            'input-control--with-label': option.label,
            'input-control--disabled': option.isDisabled,
          })}
        >
          <input
          ...
          />
          {option.label && (
            <span className={clsx('input-control__radio-text', labelClassName)}>
