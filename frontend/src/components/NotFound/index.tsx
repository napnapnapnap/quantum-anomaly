  ...
  return (
    <section className="not-found">
      ...
      <ul className="not-found__list">
        ...
        <li>
          This page was accessed from old bookmark or link and could be moved, please double check in top navigation if
          there is a link to the content you are looking for
        </li>
