...
const Description = () => (
  <div className="long-text">
    ...
    <p>
      ...
      7 km and 12 km. I suspect that the angle of next destination waypoint now plays a role as well, which is very hard
      to average.
    </p>
    <p>
      One other thing to consider is engines, on large ships they can take a lot of time to speed up. For example with
      argon engines, it takes 85 seconds for large ship to reach full speed. In that time they can cover up to around
      75km range which is not at full speed. That is why one can notice that in most cases, when trading, one should use
      terran engines.
    </p>
    <p>
      So settings mostly related to large ships are total distance covered, 1000km sounds like good estimation for range
      of 4 systems and number of gates they will have to use. That is actual jump gates, acceleration gates are fine.
    </p>
    ...
    <p>
      ...
      all ships, but not same for all highways. At the time of writing, in game they range from 11.000 to 15.000 and it
      was decided for 13.500 average. You can change that setting if you want to something else. The problem is that
      usage of highways effects their efficiency in very enormous way. So there is a setting of what % of highways you
      expect your trading ships to use. If they will be trading in core sectors, try to figure out for yourself how much
      time they will spend on highways. Argon Prime traders probably do it about 80% of time. Tharka's Ravine traders do
      it 0% of the time.
    </p>
    ...
    <p>
      So settings related to small and medium ships are total distance covered, 1000km sounds like good estimation for 4
      systems and percentage of that distance they can spend on highways.
    </p>
    <p>
